...
- Actualizada la documentación en `README.md` indicando la instalación oficial desde el registro público NPM (`npm install watchmen-logger`, `pnpm add watchmen-logger`, `yarn add watchmen-logger`).
